...
class DatabaseOperations {
	...
	public function resetDB() {
		...
		try {
			...
			foreach($tables as $t) {
				$this->dbh->exec('DROP TABLE IF EXISTS `'.$t.'`');
			}
		...
		//POPULATE TABLES
		$this->readCSVIntoDB('seeddata/seeddata_questions.csv','quizapp_questions');
		$this->readCSVIntoDB('seeddata/seeddata_answers.csv','quizapp_answers');
